    ...
    <main>
        <div class="content">
            ...
            <div class="content3">
                ...
                <a href="./academic-books-faculty.php" class="learn">Learn More</a>
            </div>
        </div>
        <div class="read-now" id="books">
            ...
            <!-- <div class="box book-1">
                <div class="box-content">
                    ...
                    <div class="box-btn">
                        <a href="#">Read Now</a>
                        <a href="./Admin/borrowBook_faculty.php">Borrow</a>
                    </div>
                </div>
            </div>

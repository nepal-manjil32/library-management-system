...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $sql = "SELECT * FROM `faculty` WHERE f_name='$username'";
...
<body style="background-color: #00ADB5">
  ...
  <main>
    <form action="faculty.php" method="post" style="background-color: #222831; border: 1px solid rgb(255, 255, 255);">
      <p class="head">Faculty Login</p>
      <!-- Username input -->
      ...
      <div class="text-center">
        <p>Not a member? <a href="create_ac_faculty.php">Register</a></p>
      </div>
    </form>
  </main>
  <!-- MDB -->
